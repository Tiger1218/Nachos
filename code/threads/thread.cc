...
Semaphore s_mutex("mutex",1);
Semaphore  s_full("full",32);
Semaphore s_empty("empty",0);
...
static void Producer()
{
	int num;
	int temp;
	s_full.P();//judge whether the buffer is full;
	s_mutex.P();//enter the crition area;
	...
	printf("\n**************************************************************************************************************************************************************\n");
	s_mutex.V();//release the critical area
	s_empty.V();//tell the consumer that there is a product
...
static void Consumer()
{
	...
	s_empty.P();//judge whether there are products in the buffer;
	s_mutex.P();//accquir the right to enter critical area
	...
	printf("\n**************************************************************************************************************************************************************\n");
	s_mutex.V();//release the critical area
	s_full.V();// tell the producer there is space to hold product.
